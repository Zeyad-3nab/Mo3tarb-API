...
namespace Mo3tarb.Repository.Identity.Migrations
{
    ...
    [Migration("20250125170150_InitailCreat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mo3tarb.Core.Entites.Identity.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mo3tarb.Core.Entites.Identity.Address", b =>
                {
                    b.HasOne("Mo3tarb.Core.Entites.Identity.AppUser", "User")
                        .WithOne("Address")
                        .HasForeignKey("Mo3tarb.Core.Entites.Identity.Address", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
